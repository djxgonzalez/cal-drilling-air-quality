---
title: "Results - Daily Annuli - Production - NO2"
...
write_csv(model_output, "point_estimates/daily_annuli_production_no2.csv")
model_output
```
...
model_output %>%
  ...
  labs(x = "Distance to well (km)", 
       y = "Marginal change in daily NO2 conc. (ppb)") +
  theme_classic() +
...
write_csv(model_output, "point_estimates/daily_annuli_production_no2_nowind.csv")
model_output
```
...
model_output <-
  tibble(
    ...
    ci_lower  = confint(model_fit)[1:30],
    ci_upper  = confint(model_fit)[35:64])
write_csv(model_output, "point_estimates/daily_annuli_production_no2_60deg.csv")
model_output
```
