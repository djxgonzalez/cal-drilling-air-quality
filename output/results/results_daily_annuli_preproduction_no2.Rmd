---
title: "Results - Daily Annuli - Preproduction - NO2"
...
write_csv(model_output, "point_estimates/daily_annuli_preproduction_no2.csv")
model_output
```
...
model_output %>%
  ...
  labs(x = "Distance to well (km)", 
       y = "Marginal change in daily NO2 conc. (µg/m^3)") +
  theme_classic() +
...
write_csv(model_output, "point_estimates/daily_annuli_preproduction_no2_nowind.csv")
model_output
```
