---
title: "Results - Daily Annuli - Preproduction - SO2"
...
#write_csv(model_output, "point_estimates/daily_annuli_preproduction_so2.csv")
model_output
```
...
model_output %>%
  ...
  labs(x = "Distance to well (km)", 
       y = "Marginal change in daily SO2 conc. (µg/m^3)") +
  theme_classic()
```
...
write_csv(model_output, "point_estimates/daily_annuli_preproduction_so2_nowind.csv")
model_output
```
