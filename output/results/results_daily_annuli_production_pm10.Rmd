...
model_output <-
  tibble(
    ...
    ci_upper  = confint(model_fit)[15:24])
write_csv(model_output, "point_estimates/daily_annuli_production_pm10.csv")
model_output
```
...
write_csv(model_output, "point_estimates/daily_annuli_production_pm10_nowind.csv")
model_output
```
