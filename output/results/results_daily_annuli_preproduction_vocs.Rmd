---
title: "Results - Daily Annuli - Preproduction - VOCs"
...
write_csv(model_output, "point_estimates/daily_annuli_preproduction_vocs.csv")
model_output
```
...
model_output %>%
  ...
  labs(x = "Distance to well (km)", 
       y = "Marginal change in daily VOCs conc. (ppb C)") +
  theme_classic() +
...
write_csv(model_output, "point_estimates/daily_annuli_preproduction_vocs_nowind.csv")
model_output
```
