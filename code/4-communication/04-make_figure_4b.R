...
data_upwind_pm25 <- aqs_daily_annuli_exposure %>%
  filter(pm25_mean > 0) %>%
  mutate(indicator_0_1km = case_when(prod_volume_upwind_0to1km >  0 ~ 1,
                                     prod_volume_upwind_0to1km == 0 ~ 0),
         indicator_1_2km = case_when(prod_volume_upwind_1to2km >  0 ~ 1,
                                     prod_volume_upwind_1to2km == 0 ~ 0),
         indicator_2_3km = case_when(prod_volume_upwind_2to3km >  0 ~ 1,
                                     prod_volume_upwind_2to3km == 0 ~ 0),
         indicator_3_4km = case_when(prod_volume_upwind_3to4km >  0 ~ 1,
                                     prod_volume_upwind_3to4km == 0 ~ 0),
         indicator_4_5km = case_when(prod_volume_upwind_4to5km >  0 ~ 1,
                                     prod_volume_upwind_4to5km == 0 ~ 0))
...
figure_4_bar_pm25_uw <- exposure_upwind_pm25 %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 32300) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_pm25_uw
ggsave(filename = "figure_4_bar_pm25_uw.png", plot = figure_4_bar_pm25_uw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")

# downwind
data_downwind_pm25 <- aqs_daily_annuli_exposure %>%
  filter(pm25_mean > 0) %>%
  mutate(indicator_0_1km = case_when(prod_volume_downwind_0to1km >  0 ~ 1,
                                     prod_volume_downwind_0to1km == 0 ~ 0),
         indicator_1_2km = case_when(prod_volume_downwind_1to2km >  0 ~ 1,
                                     prod_volume_downwind_1to2km == 0 ~ 0),
         indicator_2_3km = case_when(prod_volume_downwind_2to3km >  0 ~ 1,
                                     prod_volume_downwind_2to3km == 0 ~ 0),
         indicator_3_4km = case_when(prod_volume_downwind_3to4km >  0 ~ 1,
                                     prod_volume_downwind_3to4km == 0 ~ 0),
         indicator_4_5km = case_when(prod_volume_downwind_4to5km >  0 ~ 1,
                                     prod_volume_downwind_4to5km == 0 ~ 0))
...
figure_4_bar_pm25_dw <- exposure_downwind_pm25 %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 32300) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_pm25_dw
ggsave(filename = "figure_4_bar_pm25_dw.png", plot = figure_4_bar_pm25_dw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_co_uw <- exposure_upwind_co %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 30000) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_co_uw
ggsave(filename = "figure_4_bar_co_uw.png", plot = figure_4_bar_co_uw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_co_dw <- exposure_downwind_co %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 30000) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_co_dw
ggsave(filename = "figure_4_bar_co_dw.png", plot = figure_4_bar_co_dw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_no2_uw <- exposure_upwind_no2 %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 38000) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_no2_uw
ggsave(filename = "figure_4_bar_no2_uw.png", plot = figure_4_bar_no2_uw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_no2_dw <- exposure_downwind_no2 %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 38000) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_no2_dw
ggsave(filename = "figure_4_bar_no2_dw.png", plot = figure_4_bar_no2_dw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_o3_uw <- exposure_upwind_o3 %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 56500) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_o3_uw
ggsave(filename = "figure_4_bar_o3_uw.png", plot = figure_4_bar_o3_uw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_o3_dw <- exposure_downwind_o3 %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 56500) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_o3_dw
ggsave(filename = "figure_4_bar_o3_dw.png", plot = figure_4_bar_o3_dw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
data_upwind_vocs <- readRDS("data/deprecated/aqs_daily_annuli_exposure.rds") %>%
  filter(vocs_total > 0) %>%
  mutate(indicator_0_1km = case_when(prod_volume_upwind_0to1km >  0 ~ 1,
                                     prod_volume_upwind_0to1km == 0 ~ 0),
         indicator_1_2km = case_when(prod_volume_upwind_1to2km >  0 ~ 1,
...
figure_4_bar_vocs_uw <- exposure_upwind_vocs %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 14000) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_vocs_uw
ggsave(filename = "figure_4_bar_vocs_uw.png", plot = figure_4_bar_vocs_uw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
...
figure_4_bar_vocs_dw <- exposure_downwind_vocs %>%
  ggplot() +
  geom_bar(aes(distance, n_wells), stat = "identity") +
  ylim(0, 14000) +
  labs(x = "", y = "") +
  theme_void()
figure_4_bar_vocs_dw
ggsave(filename = "figure_4_bar_vocs_dw.png", plot = figure_4_bar_vocs_dw, 
       device = "png", height = 0.2, width = 4, path = "output/figures/")
